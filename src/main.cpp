...
int main()
{
    ...
    Vec3<float>* x = new Vec3<float>(1.0f, 1.0f, 0.9f);
    Vec3<float>* y = new Vec3<float>(1.f, -1.0f, 0.9f);
    Vec3<float>* z = new Vec3<float>(-1.0f, -1.0f, 0.9f);
    ...
    triangle2->setColors(0xff000fff, 0xff00fff0, 0xffff00f0);
